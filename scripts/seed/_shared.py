...
ADR-0015 **D1** บอกว่าสี่เส้นทางนั้น *คนละแหล่ง คนละกฎ ห้ามยุบรวม* — โมดูลนี้
...
def read_sheet_rows(
    ...
    *,
    ...
    🔴 **นี่คือทางเดียวที่ *สามเส้นที่รับ `--reviewed-at`* ใช้อ่านใบงาน** — การสร้าง
    ...
    **สาเหตุที่เป็นไปได้จริง**
    ...
    `test_no_lane_builds_its_own_csv_reader` ครอบเฉพาะสามเส้นใน `LANES` เท่านั้น
